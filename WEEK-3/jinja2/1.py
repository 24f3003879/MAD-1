...
statement_1 = Template("IIT Madras provides eduction in {{value_1}} {{space}} {{value_2}}")
...
both_12 = statement_1.render(value_1 = "Programming", space = "and", value_2 = "Data Science")
print(out_1)
print(out_2)
print(both_12)